...
// // Login Page Component with stunning design
...
//               Build intelligent customer segments, create personalized campaigns, and track performance with AI-powered
//               insights
//             </p>
...
//               onClick={onLogin}
//               disabled={isLoading}
//               className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-6 text-lg font-semibold rounded-2xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105"
//             >
//               {isLoading ? (
//                 <div className="flex items-center gap-3">
...
//                 description: "AI-powered customer segments with dynamic rules",
//                 color: "from-blue-500 to-cyan-500",
//               },
//               {
//                 icon: MessageSquare,
//                 title: "Campaign Management",
//                 description: "Personalized campaigns with real-time delivery",
...
//                 description: "Natural language queries and smart suggestions",
...
//                   <div
//                     className={`h-12 w-12 rounded-xl bg-gradient-to-r ${feature.color} flex items-center justify-center mb-3 shadow-lg`}
//                   >
...
//               <CardTitle className="text-2xl text-white">Platform Capabilities</CardTitle>
//               <CardDescription className="text-blue-100 text-lg">
//                 Everything you need for modern customer relationship management
//               </CardDescription>
//             </CardHeader>
//             <CardContent>
...
//                     <li>• Dynamic rule builder with visual interface</li>
//                     <li>• Real-time audience size and demographics</li>
...
//                     <li>• Multi-channel delivery tracking</li>
